 ...
 function setup() 
 {
  //creates the canvas
   ...
   trex = createSprite(60,height-460,20,50);
  trex.addAnimation("running", trex_running);
  trex.addAnimation("collide",trexcollide);
  trex.scale = 0.5;
  
  invisibleground = createSprite(width/2,height-240,width,10);
 ...
 function draw() 
 {
  ...
  textSize(18);
  //displaying score
  text("Score: "+ score, height-500,50);
...
function spawnObstacles(){
 if (frameCount % 80 === 0){
   var obstacle = createSprite(width,height-285,10,40);
